...
|---|---|---|
| Serveur | le domaine, les cas d'usage, les routes HTTP | que le SQL s'exécute |
| Intégration | que les contraintes des migrations tiennent | ce que l'utilisateur voit |
| Interface | ce qu'un écran affiche et ce qu'il transmet | le comportement du vrai serveur |
