...
|---|---|---|
| Serveur — 340 tests | le domaine, les cas d'usage, les routes HTTP | que le SQL s'exécute |
| Intégration — 101 tests | que les contraintes des migrations tiennent | ce que l'utilisateur voit |
