...
|---|---|---|
| Serveur — 358 tests | le domaine, les cas d'usage, les routes HTTP | que le SQL s'exécute |
| Intégration — 116 tests | que les contraintes des migrations tiennent | ce que l'utilisateur voit |
